...
**Migrering:** Sheets → Cloudflare körs på din Windows-dator med samma `CLOUDFLARE_API_TOKEN` som övriga deploys. Guide: [docs/migrera-till-cloudflare.md](docs/migrera-till-cloudflare.md).
